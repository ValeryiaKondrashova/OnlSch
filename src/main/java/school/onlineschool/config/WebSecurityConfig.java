...
//    private UserService userService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/viewHomework/**").hasRole("STUDENT")
                .antMatchers("/homework/add").hasRole("TEACHER")
                .antMatchers("/course/**").hasRole("TEACHER")
                .antMatchers("/teacher/**").hasRole("MANAGER")
                .antMatchers("/course/add").hasRole("MANAGER")
                .and()
                .csrf().disable()
                .formLogin().disable()
                ;
